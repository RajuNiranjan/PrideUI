          ...
          if (prop.name === "months") {
            ...
            return (
              ...
              >
                ...
                <SelectContent>
                  {selectItems.map((selectItems, idx) => (
                    <SelectItem key={idx} value={selectItems.value}>
                      {selectItems.label}
                    </SelectItem>
                  ))}
                </SelectContent>
            ...
            if (earliesYear && latestYear) {
              const yearsLength = latestYear - earliesYear + 1;

              selectItems = Array.from({ length: yearsLength }, (_, i) => ({
                label: (earliesYear + i).toString(),
                value: (earliesYear + i).toString(),
              }));
            }
